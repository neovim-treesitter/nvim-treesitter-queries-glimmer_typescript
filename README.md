# nvim-treesitter-queries-glimmer_typescript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-glimmer_typescript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-glimmer_typescript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **glimmer_typescript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-glimmer_typescript",
...
- [ ] Changes are scoped to `glimmer_typescript` — do not include files for other languages
